...
**버전**: 1.14.0 · **최종 수정**: 2026-09-21 · **작성자**: 김민경
...
| `docs/` | [backend_api_spec.md](backend_api_spec.md) | 백엔드와 주고받는 API 계약. 엔드포인트 넷의 요청·응답과 항목마다 "없으면 무엇이 꺼지는가". 2026-09-21 실증 데이터 검증이 근거입니다 |
