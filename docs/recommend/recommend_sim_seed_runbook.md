...
- 레시피는 Mock 카탈로그 120건입니다. 시드의 냉장고 재료 51종 가운데 30종만 Mock 에 이름이 있어 냉장고 4,267건 중 1,836건이 빠지고, 후보가 모자라 대부분 인기순 폴백까지 내려갑니다(A 집단 800명 중 폴백 없음 25 · 부족 재료 완화 140 · 인기순 635). 실 DB 에서는 이름 조인이 전부 붙습니다.
