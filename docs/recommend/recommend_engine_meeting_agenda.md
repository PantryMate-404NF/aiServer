...
| 키 | 값 |
|---|---|
| 근거 | A 트랙 공유 문서(2026-09-10)와 `origin/develop-data-part` 실체 확인. 1차 회의 결정은 2026-09-10 (2절 결정 열) |
| 타 파트 안건 | G-01~G-12. **G-01~G-05, G-07 은 1차 회의에서 결정되어 반영 완료**(작업 기록 9.5). 남은 것 G-06, G-08~G-12 |
| 내부 안건 | N-01~N-10. 회의 결과에 걸린 것 3건(N-02, N-03, N-08), 나머지는 B 가 바로 처리 |
| 급한 것 | G-09·G-10 (규약 개정 신청). 코드는 A 에 맞췄고 배치 규칙만 아직 규약에 없음 |
| 이미 맞춘 것 | 맛 축 순서·수(D-16, D-19), `stage.py` 배치(D-17), 17 피처(D-20), propensity 확률(D-21), A 엔진 조각 채택(D-22) |
