...
**버전**: 1.29.0 · **최종 수정**: 2026-09-22 · **작성자**: 유재현
...
| 브랜치 | `feat/recommend-live-serving`(`feat/recommend-monitoring` 위에서 분기, 2026-09-22). push 완료, `main` 보다 18커밋 앞, PR 없음. **`main` 병합 = 클라우드 CI/CD 가 곧장 배포**. 앞선 브랜치 `feat/recommend-engine-core` 는 PR #15(`750afdb`) · #16(`90126c2`) 으로 병합됐습니다 |
