...
| 문서 | `backend_api_spec.md` **2.4.0** · `container_handover.md` 1.4.0 · `env_variables.md` 1.3.0(3.5 모니터링 스택 변수 신설) · `backend_schema_request.md` 2.1.0(닫힌 요청임을 밝힘) · `recommend_monitoring.md` 1.3.0 |
