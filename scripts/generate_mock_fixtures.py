...
CUISINES: dict[str, CuisineSpec] = {
    ...
    "중식": CuisineSpec(["볶음밥", "탕", "덮밥", "튀김"], [45, 48, 49, 53, 36], (0.55, 0.45, 0.65)),
    "일식": CuisineSpec(["덮밥", "구이", "조림", "우동"], [45, 48, 52], (0.2, 0.5, 0.55)),
    "양식": CuisineSpec(
        ["파스타", "샐러드", "스테이크", "그라탕", "리소토"], [52, 53, 57, 49, 13], (0.2, 0.4, 0.5)
    ),
    "분식": CuisineSpec(["떡볶이", "김밥", "볶음", "전골"], [46, 48, 51, 45], (0.75, 0.55, 0.6)),
}
